...
print(cm)
print(f"Train Accuracy: {accuracy_score(y_train, best_rf.predict(X_train))}")
print(f"Test Accuracy: {accuracy_score(y_test, y_test_pred)}\n")

print(f"Train F1 Score: {f1_score(y_train, best_rf.predict(X_train))}")
print(f"Test F1 Score: {f1_score(y_test, y_test_pred)}\n")

print(f"Train Recall: {recall_score(y_train, best_rf.predict(X_train))}")
print(f"Test Recall: {recall_score(y_test, y_test_pred)}")

print(f"Train Precision: {precision_score(y_train, best_rf.predict(X_train))}")
